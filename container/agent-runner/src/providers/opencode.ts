...
export class OpenCodeProvider implements AgentProvider {
  ...
  // Memory is loaded via OpenCode's native `instructions` file pipeline
  // (buildOpenCodeConfig above), not the Claude-SDK-specific session-start
  // hook — no-op here, same as MockProvider.
